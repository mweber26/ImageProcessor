...
namespace System.Numerics
{
    ...
    public partial struct Vector3
    {
        ...
        public void CopyTo(Single[] array, int index)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(string.Format("Index was out of bounds:", index));
            }
            if ((array.Length - index) < 3)
            {
                throw new ArgumentException(string.Format("Number of elements in source vector is greater than the destination array", index));
            }
            array[index] = X;
            array[index + 1] = Y;
            array[index + 2] = Z;
